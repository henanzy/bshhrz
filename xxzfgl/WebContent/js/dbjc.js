	...
	//表头固定
		...
		function scrollHandlexincreate() {
		 ...
		 function tableToExcel(){
		    	...
		    	'<th>供水温度</th><th>回水温度</th><th>回水压力</th><th>水箱液位</th>'+
		...
		function jsArrChange(json){
			for (var i = 0 ; i < json.length ; i ++) {
				...
				arr1[17] = json[i].hsyl;
				arr1[18] = json[i].sxyw;
				arr1[19] = json[i].zjrcwd1;
				arr1[20] = json[i].zjrjwd1;
				arr1[21] = json[i].zjlcwd1;
				arr1[22] = json[i].zjljwd1;
				arr1[23] = json[i].zjrcwd2;
				arr1[24] = json[i].zjrjwd2;
				arr1[25] = json[i].zjlcwd2;
				arr1[26] = json[i].zjljwd2;
				arr1[27] = json[i].zjrcwd3;
				arr1[28] = json[i].zjrjwd3;
				arr1[29] = json[i].zjlcwd3;
				arr1[30] = json[i].zjljwd3;
				arr1[31] = json[i].zjrcwd4;
				arr1[32] = json[i].zjrjwd4;
				arr1[33] = json[i].zjlcwd4;
				arr1[34] = json[i].zjljwd4;
				arr1[35] = json[i].time;
...
function compareWord(compareWordList){
	...
	compareWordList.length=0;
	 $.ajax({
			url : getRootPath()+"/hrzCon/finddbjc.action", 
			async : false,
			dataType : "json",
			data : {
			"hrz":$('#hrz').val(),
