...
<body>
	...
	<div id="bgt"></div>
	 		   <div style="width:10%;height:7%;  position: absolute;left: 3%;top: 1%;"><a href="https://www.google.cn/chrome/">下载最新谷歌浏览器</a></div>
	<div id="mws-login">
    	...
    	<div id="mws-login-form">
        	<form class="mws-form" id="myform" action="home.action" method="post">
                ...
                <div align="center" style="color: #AAA">如果浏览器版本较低请在左上角下载最新浏览器</div>
            </form>
        </div>
    </div>
