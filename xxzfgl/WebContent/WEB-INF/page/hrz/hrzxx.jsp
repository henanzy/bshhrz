...
var list;
 ...
 $.ajax({
		url : "<%=basePath%>hrzCon/findhrz.action", 
		async : false,
		dataType : "json",
		data : {
    ...
    <div id="" class="clearfix">
        ...
        <div id="increase_word">
			<div class="mws-panel grid_4"
				style="width: 400px; min-width: 450px; margin: 30px 30%;">
				<div class="mws-panel-header">
					<span class="mws-i-24 i-pencil">新增换热站</span> <span class="close"></span>
				</div>
				<div class="mws-panel-body" style="height: 750px;">
					<form class="mws-form" action="insertHrz.action" method="post">
        ...
        <div id="change_word">
			<div class="mws-panel grid_4"
				style="width: 500px; min-width: 550px; margin: 20px 30%;">
				<div class="mws-panel-header">
					<span class="mws-i-24 i-pencil">修改信息</span> <span class="close"></span>
				</div>
				<div class="mws-panel-body" style="height: 750px;">
					<form class="mws-form" action="updateHrz.action"  method="post">
						<div class="mws-form-inline">
