	  ...
	  $.ajax({
			...
			success : function(data) {
				...
				for(var i=0 ;i<bj.length;i++){
					html += "<tr>";
					html += "<td>" + bj[i].hrz + "</td>";
					html += "<td>" + bj[i].bjlx + "</td>";
					html += "<td>" + bj[i].bjstatime + "</td>";
					html += "</tr>";
				}
	...
	<!-- 悬浮框 -->
        ...
        <div id="increase_word">
			<div class="mws-panel grid_4"
				style="width: 200px; height:100px;min-width: 500px; ">
				
				<div class="mws-panel-body">
					<form class="mws-form" action="" method="post" style="font-size: 4px" >
						<table class="mws-table">
					<thead style="width: 25px;">
						<tr>
					    	<th style="font-size: 5px; height: 5px; margin: 2px; padding: 2px; text-align: center;"  >换热站</th>
							<th style="font-size: 5px;  height: 5px; margin: 2px; padding: 2px; text-align: center;" >报警内容</th>
							<th  style="font-size: 5px;  height: 5px;  margin: 2px; padding: 2px; text-align: center;">报警时间</th>
       ...
       <!--  必要的标记，不要删除 -->
           ...
           <div id="mws-sidebar">
               ...
               <div id="mws-searchbox" class="mws-inset">
                 ...
                 <iframe scrolling="no" width="100%"   name="Conframel" id="Conframel" src="<%=basePath%>user/left.action" frameborder="0" onload="this.height=0;var fdh=(this.Document?this.Document.body.scrollHeight:this.contentDocument.body.offsetHeight);this.height=(fdh>1700?fdh:1000)"></iframe>
...
/* 	var list = ${YhList}; */
	var list = [
		{bj: "00",zdtime:0,bz: "新乡华誉大厦",dddtime: 0,ddtime: 0,dgdtime: 151.57,dw: "02",dzdtime: 11.43,fpbh: "1",fpdz: "04",gdtime: "83.42",
			hh: "101",id: 208,jf: "01",jj: "01",kg: "01",lxdh: "1522561364",mj: 120.5,ms: "01",sdwd: "26",snwd: "27",syje: -757929.5,
			time: "2019-03-09 20:55:52",xqm: "新乡华誉大厦",yf: 6,yhbh: "16000001",yhxm: "1层服务大厅",yydl: 1315.94},
